...
! function(window, document, undefined) {
  ...
  function testProps(A, e, t, n) {
    ...
    for (var i, a, d, s, l, c = ["modernizr", "tspan"]; !mStyle.style;) i = !0, mStyle.modElem = createElement(c.shift()), mStyle.style = mStyle.modElem.style;
  ...
  Modernizr.addTest("supports", newSyntax || oldSyntax), Modernizr.addTest("target", function() {
  ...
  }), Modernizr.addTest("microdata", "getItems" in document), Modernizr.addTest("mutationobserver", !!window.MutationObserver || !!window.WebKitMutationObserver), Modernizr.addTest("picture", "HTMLPictureElement" in window), Modernizr.addTest("es5object", function() {
    ...
    return !0
  }), Modernizr.addTest("es6math", !!(Math && Math.clz32 && Math.cbrt && Math.imul && Math.sign && Math.log10 && Math.log2 && Math.log1p && Math.expm1 && Math.cosh && Math.sinh && Math.tanh && Math.acosh && Math.asinh && Math.atanh && Math.hypot && Math.trunc && Math.fround)), Modernizr.addTest("promises", function() {
  ...
  isSVG || ! function(A, e) {
    ...
    function i(A, t, n) {
      ...
      n || (n = o(t));
      var r;
      return r = n.cache[A] ? n.cache[A].cloneNode() : v.test(A) ? (n.cache[A] = n.createElem(A)).cloneNode() : n.createElem(A), !r.canHaveChildren || h.test(A) || r.tagUrn ? r : n.frag.appendChild(r)
    }
    ...
    function s(A) {
      A || (A = e);
      var n = o(A);
      return !y.shivCSS || m || n.hasCSS || (n.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), f || d(A, n), A
    }
    ...
    function u(A) {
      for (var e, t = A.split("{"), r = t.length, o = RegExp("(^|[\\s,>+~])(" + n().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), i = "$1" + b + "\\:$2"; r--;) e = t[r] = t[r].split("}"), e[e.length - 1] = e[e.length - 1].replace(o, i), t[r] = e.join("}");
      return t.join("{")
    }
    ...
    function w(A) {
      ...
      var n, r, i = o(A),
        a = A.namespaces,
        d = A.parentWindow;
      return !z || A.printShived ? A : ("undefined" == typeof a[b] && a.add(b), d.attachEvent("onbeforeprint", function() {
        e();
    ...
    ! function() {
      try {
        ...
        A.innerHTML = "<xyz></xyz>", m = "hidden" in A, f = 1 == A.childNodes.length || function() {
          e.createElement("a");
    ...
    var B = /^$|\b(?:all|print)\b/,
      ...
      z = !f && function() {
        ...
        return !("undefined" == typeof e.namespaces || "undefined" == typeof e.parentWindow || "undefined" == typeof t.applyElement || "undefined" == typeof t.removeNode || "undefined" == typeof A.attachEvent)
      }();
    ...
    function A(A, e, t) {
      function n(e) {
        var n = e && "load" === e.type ? 1 == r.width : !1,
          o = "webp" === A;
        addTest(A, o ? new Boolean(n) : n), t && t(e)
      }
      var r = new Image;
  ...
  Modernizr.addTest("todataurljpeg", function() {
  ...
  }), Modernizr.addTest("capture", "capture" in createElement("input")), Modernizr.addTest("formattribute", function() {
    ...
    return !1
  }), Modernizr.addTest("seamless", "seamless" in createElement("iframe")), Modernizr.addTest("placeholder", "placeholder" in createElement("input") && "placeholder" in createElement("textarea")), Modernizr.addTest("sandbox", "sandbox" in createElement("iframe")), Modernizr.addTest("imgcrossorigin", "crossOrigin" in createElement("img")), Modernizr.addTest("srcdoc", "srcdoc" in createElement("iframe")), Modernizr.addAsyncTest(function() {
  ...
  }), Modernizr.addTest("inputformmethod", !!("formMethod" in createElement("input"))), Modernizr.addTest("scriptasync", "async" in createElement("script")), Modernizr.addTest("scriptdefer", "defer" in createElement("script")), Modernizr.addTest("stylescoped", "scoped" in createElement("style")), Modernizr.addTest("inlinesvg", function() {
    var A = createElement("div");
  ...
  Modernizr._q.push(function() {
    ...
    var e = A.childNodes[2],
      ...
      d = parseInt((window.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle).width, 10);
  ...
  Modernizr.addTest("xhrresponsetypeblob", testXhrType("blob")), Modernizr.addTest("xhrresponsetypetext", testXhrType("text")), Modernizr.addTest("xhrresponsetypearraybuffer", testXhrType("arraybuffer")), Modernizr.addTest("xhrresponsetypedocument", testXhrType("document")), Modernizr.addTest("xhrresponsetypejson", testXhrType("json"));
