            ...
            <div class="news-box">
                <div class="news-content">
                    <ul>
                        <li>
                            <div class="box-news">
                                <div class="close-news">EDITAR</div>
                                <div class="post-news">
                                    <h3>But I must explain</h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo beatae vitae dicta sunt explicabo.</p>
                                </div>
                            </div>
